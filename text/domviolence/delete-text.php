...
if ((isset($_POST['name'])) && ($_POST['name'] != "")) {
  $deleteSQL = sprintf("DELETE FROM domviolence WHERE name=%s",
...
mysql_select_db($database_Ekaterina, $Ekaterina);
$query_Recordset1 = sprintf("SELECT name, added, kratko FROM domviolence WHERE name = '%s'", $colname_Recordset1);
