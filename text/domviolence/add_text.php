...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "Добавить статью")) {
  $insertSQL = sprintf("INSERT INTO domviolence (author, name, added, text, kratko) VALUES (%s, %s, %s, %s, %s)",
...
<html>
<head>
<title>Добавить статью- Домашнее насилие</title>
...
<body>
<p align="center"><strong>Домашнее насилие <br>
    <span class="style4">Обязательно заполните все поля
    </span></strong></p>
<form action="<?php echo $editFormAction; ?>" method="POST" name="Добавить статью" id="Добавить статью" lang="ru">
  <p>Дата 
  ...
  <p class="style5">Очень ВАЖНО!!!!</p>
  <p class="style5">для форматирования текста по абзацам пишите абзац между тэгами: <br>
      <span class="style4">&lt;p&gt; абзац &lt;/p&gt;
  </span></p>
  <p class="style5">И таким образом вписывается каждый абзац  </p>
