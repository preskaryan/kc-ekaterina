...
$query_Recordset1 = "SELECT author, name, added, kratko FROM domviolence ORDER BY added DESC";
...
<p> 
  ...
  <a href="<?php printf("../../domviolence/%25s?pageNum_Recordset1=%25d%25s", $currentPage, max(0, $pageNum_Recordset1 - 1), $queryString_Recordset1); ?>">&lt;&lt;&lt;Предыдущая страница....</a>
  <?php } // Show if not first page ?> 
  <?php if ($pageNum_Recordset1 < $totalPages_Recordset1) { // Show if not last page ?>
  <a href="<?php printf("../../domviolence/%25s?pageNum_Recordset1=%25d%25s", $currentPage, min($totalPages_Recordset1, $pageNum_Recordset1 + 1), $queryString_Recordset1); ?>"> .....Следующая страница&gt;&gt;&gt;</a>
