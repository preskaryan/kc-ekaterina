...
if ((isset($_POST['name'])) && ($_POST['name'] != "")) {
  $deleteSQL = sprintf("DELETE FROM sexnasilie WHERE name=%s",
...
mysql_select_db($database_Ekaterina, $Ekaterina);
$query_Recordset1 = sprintf("SELECT name, added, kratko FROM sexnasilie WHERE name = '%s'", $colname_Recordset1);
...
<body>
<p align="center">Сексуальное насилие <br>
  </p>
