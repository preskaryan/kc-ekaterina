...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "Добавить статью")) {
  $insertSQL = sprintf("INSERT INTO realnoistorii (author, name, added, text, kratko) VALUES (%s, %s, %s, %s, %s)",
...
<html>
<head>
<title>Добавить статью-Реальные истории</title>
...
<body><form action="<?php echo $editFormAction; ?>" method="POST" name="Добавить статью" id="Добавить статью" lang="ru">
  <p align="center"><strong>Реальные истории <br>
