  ...
  <tr>
    <th scope="col"><div align="center">
      ...
      <table width="100%"  border="0">
        <tr>
          <td width="15%">&nbsp;</td>
          <td width="78%"><div align="left"><span class="style2"><?php echo $row_Recordset1['text']; ?></span></div></td>
          <td width="7%">&nbsp;</td>
        </tr>
      </table>      <p>&nbsp; </p>
    ...
    <p align="right"><strong> <?php echo date("d.m.Y", strtotime($row_Recordset1['added'])); ?><br>
      ...
      <p>
        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="400" height="60">
          <param name="movie" value="../../images/banners/index/001.swf">
          <param name=quality value=high>
          <embed src="../../images/banners/index/001.swf" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="400" height="60"></embed>
        </object>
      </p></th>
  </tr>
  <tr valign="middle">
    <td height="40">
      <p align="center" class="style4"><em>&copy; Свердловская региональная общественная организация <br>
