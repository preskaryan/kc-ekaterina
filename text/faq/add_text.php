...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "Добавить статью")) {
  $insertSQL = sprintf("INSERT INTO faq (vopros, otvet, added, avtor) VALUES (%s, %s, %s, %s)",
                       GetSQLValueString($_POST['vopros'], "text"),
                       GetSQLValueString($_POST['otvet'], "text"),
...
<body>
<div align="center"><strong>Вопрос- ответ </strong>
</div>
<form action="<?php echo $editFormAction; ?>" method="POST" name="Добавить статью" id="Добавить статью" lang="ru"><p align="center"><strong><br>
  ...
  <p>Вопрос 
    <textarea name="vopros" cols="50" rows="5" wrap="VIRTUAL" id="vopros"></textarea>
    </p>
  <p> Ответ...  
    <textarea name="otvet" cols="50" wrap="VIRTUAL" id="otvet"></textarea> 
