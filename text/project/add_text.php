...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "Добавить статью")) {
  $insertSQL = sprintf("INSERT INTO project (author, name, added, text, kratko) VALUES (%s, %s, %s, %s, %s)",
...
<html>
<head>
<title>Добавить статью-Проекты</title>
...
<body><form action="<?php echo $editFormAction; ?>" method="POST" name="Добавить статью" id="Добавить статью" lang="ru">
  <p align="center"><strong>Проекты<br>
  <span class="style4">Обязательно заполните все поля </span>  </strong></p>
  <p>Дата 
    <input name="added" type="text" value="<?php echo date ("Y-m-d"); ?>" size="12" maxlength="12">
  </p>
  <p> Автор 
  ...
  <p>Краткое содержание 
    <input name="kratko" type="text" id="kratko" size="37" maxlength="255"> 
