...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "Добавить статью")) {
  $insertSQL = sprintf("INSERT INTO traffiking (author, name, added, text, kratko) VALUES (%s, %s, %s, %s, %s)",
...
<html>
<head>
<title>Добавить статью-Траффик</title>
...
<body><form action="<?php echo $editFormAction; ?>" method="POST" name="Добавить статью" id="Добавить статью" lang="ru">
  <p align="center"><strong>Траффик<br>
  ...
  <p align="center"><span class="style4">&lt;strong&gt;</span> <strong>жирный</strong> <span class="style4">&lt;/strong&gt; </span></p>
  <p align="center"><span class="style4">&lt;em&gt;</span> <em>курсив</em> <span class="style4">&lt;/em&gt;</span> </p>
  <p align="center"><span class="style4">&lt;strong&gt;&lt;em&gt;</span> <em><strong>жирный курсив</strong></em> <span class="style4">&lt;/em&gt;&lt;/strong&gt;</span> </p>
  <p align="center">переход на следующую строку <span class="style4">&lt;br&gt; </span><br>
  без разрыва текста <span class="style4">&lt;br&gt;</span> <br>
  для удобоваримости :-) например для списков: <span class="style4">&lt;br&gt;</span> <br>
  1. пункт <span class="style4">&lt;br&gt;</span> <br>
  2. пункт <span class="style4">&lt;br&gt;</span> <br>
  3. пункт <span class="style4">&lt;br&gt;</span> </p>
  <p>&nbsp;</p>
