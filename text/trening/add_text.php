...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "Добавить статью")) {
  $insertSQL = sprintf("INSERT INTO trening (author, name, added, text, kratko) VALUES (%s, %s, %s, %s, %s)",
...
<html>
<head>
<title>Добавить статью-Тренинги</title>
...
<body><form action="<?php echo $editFormAction; ?>" method="POST" name="Добавить статью" id="Добавить статью" lang="ru">
  <p align="center"><strong>Тренинги<br>
