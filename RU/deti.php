      ...
      <tr bgcolor="#FFFFFF">
        ...
        <td width="60%" valign="top" bgcolor="#FFFFFF">
          <?php if ($totalRows_Recordset2 == 0) { // Show if recordset empty ?>
			...
			<p align="justify" class="text">По данным официальной статистики около
							2 миллионов детей ежегодно подвергается жестокому обращению. Каждый десятый ребенок гибнет,
							2 тысячи кончают жизнь самоубийством,
							более 50 тысяч уходят из дома.</p>																						
			<p align="justify" class="text">Около 60 процентов детей, которые были или жертвами, или свидетелям бытового насилия, не могут избежать
							его и в зрелом возрасте - они опять становятся его жертвами или сами его совершают.</p>
...
<span class="text"><br>
          ...
          <p> <span class="bodyHeader" align="center"><?php echo $row_Recordset2['name']; ?></span></p>
