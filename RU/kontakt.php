      ...
      <div id="mainpage">
         ...
         <!--<p align="justify" class="text">Телефоны доверия:</p>-->
           <table border="0" bordercolor="#3399FF" cellspacing="10" cellpadding="5px" cols="2" width="100%">
                <tr>
                    <td align="left" width="25%" height="40px" >Информационная линия для пострадавших от насилия в семье</td>
                    <td align="left" class="anotherColor">8 (952) 146-222-3 <br><font size="2">(с 12:00 до 17:00, <br>ПН, ЧТ и ПТ)</font></td>
                </tr>
        <tr>
                    <td align="left" height="40px" >Адрес электронной почты:</td>
        ...
        <tr>
                    <td align="left" height="40px" ><a href="https://vk.com/public91333889" target="_blank">Кризисный центр "Екатерина"</td>
                    <td align="left">Новости о деятельности кризисного центра.</td>
                </tr>
        <tr>
                    <td align="left" height="40px" ><a href="https://vk.com/public89672721" target="_blank">Вместе мы сила!</td>
                    <td align="left">Новости о деятельности Коалиции кризисных центров Урало-Сибирского региона, контакты государственных кризисных центров и общественных организаций.</td>
                </tr>
        <tr>
                    <td align="left" height="40px" ><a href="https://vk.com/event68450507" target="_blank">Счастливый ребёнок - забота каждого!</td>
