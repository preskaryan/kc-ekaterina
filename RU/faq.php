  ...
  <tr>
    <th scope="col">
      ...
      <tr bgcolor="#FFFFFF">
        ...
        <td width="60%" height="253" valign="top" bgcolor="#FFFFFF"><p align="center" class="xbig anotherColor">Свои вопросы Вы можете присылать на <a href="mailto:notviolence@etel.ru">notviolence@etel.ru</a></p>
          <ol>
             <?php do { ?>
             <li><div>
        ...
        <td width="20%" valign="top" bgcolor="#B7D6F8"><div>
		</div></td>
        </tr>
      <tr bgcolor="#B7D6F8">
