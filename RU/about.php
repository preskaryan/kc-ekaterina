		...
		<div id="content">
			...
			<div id="mainpage">
				<div class="information">
    				...
    				Сотрудники центра организуют и проводят тренинги на эти темы для различных групп населения: сотрудников полиции, педагогов, специалистов по социальной работе, врачей, мировых судей, адвокатов.<br>
    				Сотрудники «Екатерины» оказывают консультативную и методическую помощь женским организациям и социальным службам Свердловской области и Уральского региона по созданию у них кризисных центров для женщин. </p>
          			...
          			<p align="left" class="text">Миссия организации - выступать в защиту женщин, подвергающихся насилию, и обеспечивать их безопасность путем предотвращения и профилактики насилия, а также предоставления услуг женщинам, пострадавшим (страдающим) от домашнего насилия, сексуального надругательства и в результате незаконного вывоза людей (торговли женщинами).</p>
				</div>
