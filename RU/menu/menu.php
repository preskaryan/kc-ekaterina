		...
		<a href="..\..\en\abouten.php"><div class="menuHead" id="menu1">English version</div></a>
		<a href="javascript:toggleClamShellMenu('menu0')"><div class="menuHead" id="menu10">О нас</div></a>
			<span id="menu0">
		...
		<a href="javascript:toggleClamShellMenu('menu12')"><div class="menuHead" id="menu7">Коалиция</div></a>
			<span id="menu12">
				<a href="koaliciya.php"><div class="menuOption" id="option6">Коалиция</div></a>
				<a href="koaliciyaMembers.php"><div class="menuOption" id="option7">Члены коалиции</div></a>
			</span>
