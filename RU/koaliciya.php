...
<body onload="initPage()">
    ...
    <div id="content">
      ...
      <div id="mainpage">
          ...
          <p align="justify" class="text">На сегодняшний день Партнерское соглашение о вступлении в Коалицию подписали 30 организаций.</p>
        ...
        <br>
          ...
          <p align="right"><span class="newsDate"><?php echo $row_Recordset2['date']; ?></span></p> 
        </div>
        ...
        <div class="rightmenu">
            ...
            <?php do { ?>
             <table class="news">
              <tr>
                <td rowspan="2" width="5%"><img src="../image/strelka2.jpg" width="7" height="7"></td>
